...
public class OptaplannerTestContainer extends TestContainer {

    public OptaplannerTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/hh/optaplanner/app.properties",
    ...
    public static class Common extends OptaplannerTestContainer {

        public static final OptaplannerTestContainer.Common INSTANCE = new OptaplannerTestContainer.Common();
